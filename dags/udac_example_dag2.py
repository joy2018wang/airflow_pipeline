...
run_quality_checks = DataQualityOperator(
    ...
    redshift_conn_id="redshift",
    checklist = [{'test_sql': f"SELECT COUNT(*) FROM songs",'expected_result': 0, 'comparisonfun': (lambda a,b: a >= b)}],
    dag=dag
)
...
start_operator >> [stage_songs_to_redshift,stage_events_to_redshift] >> load_songplays_table >> [load_song_dimension_table,
